...
ORIGINAL_CSV_PATH = os.path.join(ROOT_DIR,"data/processed/random_percent_point2.csv")
VIDEO_IDS_LIST_PATH = os.path.join(ROOT_DIR,"data/interim/video_ids_random_percent_point2.txt")
COMMENTS_DOWNLOAD_PATH = os.path.join(ROOT_DIR,"data/processed/comments_json/random_percent_point2")
...
def run_script(start_from, should_convert_to_text_file):
    """
    This function will download comments for videos in the random_percent_point2.csv
    
    Args:
        start_from (int):   
            The position of the video id in the random_percent_point2.csv. Because the program
            will create a text file from the video ids in the csv, the position will be index + 1

        should_convert_to_text_file (bool): 
            If True, the program will open the random_percent_point2.csv and extract all the video ids.
            The program expects the random_percent_point2.csv file to exist in the same place as this 
            python script.
    ...
    How this script works:
        1.  The function will first open the random_percent_point2.csv file from the path provided
    ...
    if (should_convert_to_text_file == 'y') or (should_convert_to_text_file == 'yes'):
        print("Opening random_percent_point2.csv")
    ...
    comments_file_name = f'randompercentpoint2_videos_comments_{start_from}.csv'
...
if __name__ == "__main__":
    ...
    try:
        ...
        This argument ensures that the txt file is created from the random_percent_point2.csv. 
        """
        print(msg)
